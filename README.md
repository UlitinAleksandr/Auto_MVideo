Написание автотестов для сайта mvideo.ru. Для отслеживания процесса установлен порядок прохождения тестов, подключено логирование и формирование отчета Allure.
